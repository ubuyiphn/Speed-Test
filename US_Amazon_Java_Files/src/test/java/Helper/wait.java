...
public class wait 
{
    ...
    public static void waitforlistpage() throws MessagingException, IOException
    {
    	try {
    		...
    		//ImportedPackages.USProductsAvailability = Browsers.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(URLandXPATH.arabicamazonproductclickxpathatlistpage)));
